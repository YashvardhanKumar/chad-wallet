...
export default function TrendingList({
  ...
  return (
    <div className="flex flex-1 transition-[width] pb-2 duration-100 ease-out overflow-hidden w-70 2xl:w-85">
                ...
                {activeFilter === "Graduated" && (
                  <div className="flex items-start gap-2 p-2.5 mb-1 rounded-lg bg-yellow-900/20 text-xs text-text-primary/60">
                    ...
                    <span className="flex-1">
                      ...
                      Newly graduated tokens are highly volatile. Tokens can be
                      launched by anyone, including bad actors.
                    </span>
                ...
                {activeFilter === "Bonding" && (
                  <div className="flex items-start gap-2 p-2.5 mb-1 rounded-lg bg-yellow-900/20 text-xs text-text-primary/60">
                    ...
                    <span className="flex-1">
                      ...
                      Bonding tokens are amazing but may never graduate. Tokens
                      can be launched by anyone, including bad actors.
                    </span>
                    <button className="shrink-0 mt-0.5 hover:opacity-80 cursor-pointer">
                      <FiX size={14} className="text-text-tertiary" />
                    </button>
                          ...
                          <div className="flex flex-col gap-2">
                            <div className="flex justify-between items-start">
                              ...
                              <button
                                ...
                                tabIndex={-1}
                              >
                                {watchlistAddresses.includes(token.address) ? (
                                  <FaStar size={20} />
                                ) : (
                                  <FaRegStar size={20} />
                                )}
